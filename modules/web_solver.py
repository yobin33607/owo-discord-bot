...
class WebSolver:
    """Manual captcha solving: queues captchas for the user and resolves
    them via the dashboard, a browser popup, or the embedded hCaptcha widget.

    The paid auto-solve services (YesCaptcha, NopeCHA, AntiCaptcha, Captchaly)
    and the ONNX AI solver were removed — captchas are solved manually only.
    """
