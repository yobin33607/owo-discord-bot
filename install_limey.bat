...
set "REPO_URL=https://github.com/limeyself/owo-discord-bot.git"
...
set "PREBUILT_URL=https://raw.githubusercontent.com/limeyself/owo-discord-bot/main/prebuilt/venv-windows.zip"
set "USED_PREBUILT=0"
